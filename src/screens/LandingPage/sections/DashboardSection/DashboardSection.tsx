  ...
  return (
    <section className="relative w-full min-h-screen bg-white overflow-hidden">
      ...
      <div className="absolute inset-0 flex items-center justify-center px-4 py-12">
        <div className="flex flex-col items-center gap-4 md:gap-6 max-w-2xl w-full animate-fade-up">
          <img
          ...
          <h1 className="[font-family:'Poppins',Helvetica] font-semibold text-white text-3xl md:text-4xl lg:text-5xl xl:text-6xl text-center tracking-[0] leading-tight md:leading-[56px]">
            India&apos;s #1
            <br />
            Real-Time Nightlife Platform
          </h1>

          <p className="[font-family:'Poppins',Helvetica] font-normal text-white text-base md:text-lg lg:text-xl text-center tracking-[0] leading-6 md:leading-7 max-w-[520px] mb-2">
          ...
          <div className="flex items-center gap-2 mt-6 md:mt-8 animate-float">
