...
export const PartnerWithUsForm: React.FC = () => {
    ...
    return (
      <div className="w-full max-w-xl mx-auto text-center py-12 animate-fade-in">
        ...
        <p className="[font-family:'Inter',Helvetica] text-white/70 text-sm md:text-base">
          Thank you for your interest in partnering with us. We'll get back to you soon.
        </p>
      </div>
    );
  }
  ...
  return (
    <div className="w-full">
      <h2 className="[font-family:'Poppins',Helvetica] font-semibold text-white text-2xl sm:text-3xl md:text-4xl mb-6 sm:mb-8 text-center">
        Partner With Us
      </h2>
      ...
      <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-5">
        ...
        <div>
          <input
            type="text"
            placeholder="name of club/GSTIN"
            value={clubNameGstin}
        ...
        {/* Descriptive Text */}
        <div className="pt-2">
          <p className="[font-family:'Inter',Helvetica] font-normal text-white/60 text-xs sm:text-sm md:text-base leading-relaxed">
            Nibh ullamcorper fusce nulla congue. Manto ipsum amet ut faucibus id id. Omare eget eu aliquam urna lobortis. Fusce leo lectus hac aliquet dictum consequat justo.
          </p>
        </div>
